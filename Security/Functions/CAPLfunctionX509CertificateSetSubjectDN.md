[Open topic with navigation](../../../../../CANoeDEFamily.htm#Topics/CAPLFunctions/Security/Functions/CAPLfunctionX509CertificateSetSubjectDN.md)

**CAPL Functions** » [Security](../CAPLFunctionsSecurityOverview.md) » X509Certificate_SetSubjectDN

# X509Certificate_SetSubjectDN

[Valid for](../../../Shared/FeatureAvailability.md):  CANoe DE • CANoe4SW DE

## Method Syntax

`dword X509Certificate_SetSubjectDN(qword objectHandle, qword newValue)`

## Description

Setter function for the Subject field of the X.509 Certificate handle. Can also be used to remove the field by calling the function with value 0 (NULL).
