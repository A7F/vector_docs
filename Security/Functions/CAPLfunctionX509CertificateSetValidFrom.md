[Open topic with navigation](../../../../../CANoeDEFamily.htm#Topics/CAPLFunctions/Security/Functions/CAPLfunctionX509CertificateSetValidFrom.md)

**CAPL Functions** » [Security](../CAPLFunctionsSecurityOverview.md) » X509Certificate_SetValidFrom

# X509Certificate_SetValidFrom

[Valid for](../../../Shared/FeatureAvailability.md): CANoe DE • CANoe4SW DE

## Method Syntax

`dword X509Certificate_SetValidFrom(qword objectHandle, char[] newValue)`

## Description

Setter function for the Valid From (NotBefore) field of the X.509 Certificate handle. String supports ASN.1 UTCTime or ASN.1 GeneralizedTime representation.
