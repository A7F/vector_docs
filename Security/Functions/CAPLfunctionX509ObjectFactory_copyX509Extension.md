[Open topic with navigation](../../../../../CANoeDEFamily.htm#Topics/CAPLFunctions/Security/Functions/CAPLfunctionX509ObjectFactory_copyX509Extension.md)

**CAPL Functions** » [Security](../CAPLFunctionsSecurityOverview.md) » X509ObjectFactory_copyX509Extension

# X509ObjectFactory_copyX509Extension

[Valid for](../../../Shared/FeatureAvailability.md): CANoe DE • CANoe4SW DE

## Method Syntax

`dword X509ObjectFactory_copyX509Extension(qword objectHandle, qword& outHandleExtension, qword toBeCopiedHandle)`

## Description

Creation function for deep copy of handle with type X509Extension.
