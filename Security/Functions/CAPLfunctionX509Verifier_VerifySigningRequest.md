[Open topic with navigation](../../../../../CANoeDEFamily.htm#Topics/CAPLFunctions/Security/Functions/CAPLfunctionX509Verifier_VerifySigningRequest.md)

## X509Verifier_VerifySigningRequest

[CAPL Functions](../../CAPLfunctions.md) » [Security](../CAPLFunctionsSecurityOverview.md) » X509Verifier_VerifySigningRequest
...
`dword X509Verifier_VerifySigningRequest(qword objectHandle, qword csrHandle, dword& verificationResult)`

### Description

Verification function for PKCS#10 Certificate Signing Requests (CSR). This function verifies that the proof of possession is valid for the claimed public key in this CSR. The function will fail in case of syntactically or structural invalid CSR. For this function, no trusted certificate is required and not all content fields of the certificate are validated.
