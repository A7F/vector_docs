[Open topic with navigation](../../../../../CANoeDEFamily.htm#Topics/CAPLFunctions/Security/Functions/CAPLfunctionX509Extensions_Erase.md)

## X509Extensions_Erase

[CAPL Functions](../../CAPLfunctions.md) » [Security](../CAPLFunctionsSecurityOverview.md) » X509Extensions_Erase
...
`dword X509Extensions_Erase(qword objectHandle, qword newValue)`

### Description

Erase function to delete entry from Extensions lists. The erased elements will be deleted and all handles to this element will be invalidated. If you need to re-use an element after erasing, make sure to copy it before it is erased. Valid indices will start at zero and end with 'size - 1'.
