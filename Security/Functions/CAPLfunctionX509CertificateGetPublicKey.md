[Open topic with navigation](../../../../../CANoeDEFamily.htm#Topics/CAPLFunctions/Security/Functions/CAPLfunctionX509CertificateGetPublicKey.md)

**CAPL Functions** » [Security](../CAPLFunctionsSecurityOverview.md) » X509Certificate_GetPublicKey

# X509Certificate_GetPublicKey
...
```
dword X509Certificate_GetPublicKey(qword objectHandle, byte[] outBuffer, dword outBufferLength)
```

## Description

Getter function for the Public Key field of the X.509 Certificate handle.
