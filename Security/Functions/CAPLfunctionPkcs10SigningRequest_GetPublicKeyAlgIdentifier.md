[Open topic with navigation](../../../../../CANoeDEFamily.htm#Topics/CAPLFunctions/Security/Functions/CAPLfunctionPkcs10SigningRequest_GetPublicKeyAlgIdentifier.md)

**CAPL Functions** » [Security](../CAPLFunctionsSecurityOverview.md) » Pkcs10SigningRequest_GetPublicKeyAlgIdentifier

# Pkcs10SigningRequest_GetPublicKeyAlgIdentifier
...
```
dword Pkcs10SigningRequest_GetPublicKeyAlgIdentifier(qword objectHandle, qword& outHandleAlgIdentifier)
```

## Description

Getter function for the Public Key Algorithm Identifier field of the PKCS#10 CSR handle.

## Parameters

- **objectHandle**: (in) Handle with type 'Pkcs10SigningRequest'. The function will be called in context of this handle.
