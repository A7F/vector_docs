[Open topic with navigation](../../../../../CANoeDEFamily.htm#Topics/CAPLFunctions/Security/Functions/CAPLfunctionX509CertificateGetPublicKeyAlgIdentifier.md)

**CAPL Functions** » [Security](../CAPLFunctionsSecurityOverview.md) » X509Certificate_GetPublicKeyAlgIdentifier

# X509Certificate_GetPublicKeyAlgIdentifier

[Valid for](../../../Shared/FeatureAvailability.md): CANoe DE • CANoe4SW DE

## Method Syntax

`dword X509Certificate_GetPublicKeyAlgIdentifier(qword objectHandle, qword& outHandleAlgIdentifier)`

## Description

Getter function for the Public Key Algorithm Identifier field of the X.509 Certificate handle.
