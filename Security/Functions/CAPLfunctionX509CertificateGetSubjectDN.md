[Open topic with navigation](../../../../../CANoeDEFamily.htm#Topics/CAPLFunctions/Security/Functions/CAPLfunctionX509CertificateGetSubjectDN.md)

**CAPL Functions** » [Security](../CAPLFunctionsSecurityOverview.md) » X509Certificate_GetSubjectDN

# X509Certificate_GetSubjectDN

[Valid for](../../../Shared/FeatureAvailability.md): CANoe DE • CANoe4SW DE

## Method Syntax

`dword X509Certificate_GetSubjectDN(qword objectHandle, qword& outHandleDN)`

## Description

Getter function for the Subject field of the X.509 Certificate handle.
