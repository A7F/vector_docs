[Open topic with navigation](../../../../../CANoeDEFamily.htm#Topics/CAPLFunctions/Security/Functions/CAPLfunctionX509CertificateSetValidTo.md)

# X509Certificate_SetValidTo

[CAPL Functions](../../CAPLfunctions.md) » [Security](../CAPLFunctionsSecurityOverview.md) » X509Certificate_SetValidTo

**Valid for:** [CANoe DE](../../../Shared/FeatureAvailability.md) • CANoe4SW DE

## Method Syntax

`dword X509Certificate_SetValidTo(qword objectHandle, char[] newValue)`

## Description

Setter function for the Valid To (NotAfter) field of the X.509 Certificate handle. String supports ASN.1 UTCTime or ASN.1 GeneralizedTime representation.
