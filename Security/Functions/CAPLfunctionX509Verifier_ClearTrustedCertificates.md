[Open topic with navigation](../../../../../CANoeDEFamily.htm#Topics/CAPLFunctions/Security/Functions/CAPLfunctionX509Verifier_ClearTrustedCertificates.md)

[CAPL Functions](../../CAPLfunctions.md) » [Security](../CAPLFunctionsSecurityOverview.md) » X509Verifier_ClearTrustedCertificates

# X509Verifier_ClearTrustedCertificates

[Valid for](../../../Shared/FeatureAvailability.md):  CANoe DE • CANoe4SW DE

## Method Syntax

dword X509Verifier_ClearTrustedCertificates(qword objectHandle)

## Description

Clear function for the trust store. This function removes all trusted certificates from the store. The certificates will be destroyed.
