[Open topic with navigation](../../../../../CANoeDEFamily.htm#Topics/CAPLFunctions/Security/Functions/CAPLfunctionX509Decoder_DecodeCertificate.md)

## X509Decoder_DecodeCertificate

[CAPL Functions](../../CAPLfunctions.md) » [Security](../CAPLFunctionsSecurityOverview.md) » X509Decoder_DecodeCertificate
...
`dword X509Decoder_DecodeCertificate(qword objectHandle, qword& outHandleCertificate, byte[] certificateData, dword certificateDataLength)`

### Description

Decoding function for an X.509 Certificate from binary data in DER or PEM format. Function will fail in case of invalid encoded data or invalid ASN.1 or X.509 Certificate structure.
