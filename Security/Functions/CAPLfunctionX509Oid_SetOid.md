[Open topic with navigation](../../../../../CANoeDEFamily.htm#Topics/CAPLFunctions/Security/Functions/CAPLfunctionX509Oid_SetOid.md)

## X509Oid_SetOid

**CAPL Functions** » **Security** » X509Oid_SetOid

### Method Syntax

`dword X509Oid_SetOid(qword objectHandle, dword newValue, dword newValueLength)`

### Description

Setter function for the numerical content field of the Object Identifier handle.
