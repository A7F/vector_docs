[Open topic with navigation](../../../../../CANoeDEFamily.htm#Topics/CAPLFunctions/Security/Functions/CAPLfunctionX509DNAttributes_Erase.md)

**CAPL Functions** » [Security](../CAPLFunctionsSecurityOverview.md) » X509DNAttributes_Erase

# X509DNAttributes_Erase

[Valid for](../../../Shared/FeatureAvailability.md): CANoe DE • CANoe4SW DE

## Method Syntax

dword X509DNAttributes_Erase(qword objectHandle, qword newValue)

## Description

Erase function to delete entry from DN Attribute lists. The erased elements will be deleted and all handles to this element will be invalidated. If you need to re-use an element after erasing, make sure to copy it before it is erased. Valid indices will start at zero and end with 'size - 1'.
