[Open topic with navigation](../../../../../CANoeDEFamily.htm#Topics/CAPLFunctions/Security/Functions/CAPLfunctionX509CertificateSetAuthorityKeyIdentifierFromKey.md)

**CAPL Functions** » [Security](../CAPLFunctionsSecurityOverview.md) » X509Certificate_SetAuthorityKeyIdentifierFromKey

# X509Certificate_SetAuthorityKeyIdentifierFromKey

[Valid for](../../../Shared/FeatureAvailability.md): CANoe DE • CANoe4SW DE

## Method Syntax

dword X509Certificate_SetAuthorityKeyIdentifierFromKey(qword objectHandle, byte[] keyData, dword keyDataLength)

## Description

Setter function for the content of Extension 'AuthorityKeyIdentifier' ('AKID') with OID '2.5.29.35' of the X.509 Certificate handle from the key argument by calculating SHA-1 hash of the key and setting the value. This function will add the Extensions list structure and the Extension itself if it is not existing.
