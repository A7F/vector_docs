[Open topic with navigation](../../../../../CANoeDEFamily.htm#Topics/CAPLFunctions/Security/Functions/CAPLfunctionX509Verifier_AddTrustedCertificate.md)

## X509Verifier_AddTrustedCertificate

[CAPL Functions](../../CAPLfunctions.md) » [Security](../CAPLFunctionsSecurityOverview.md) » X509Verifier_AddTrustedCertificate

**Valid for:** CANoe DE • CANoe4SW DE

### Method Syntax

`dword X509Verifier_AddTrustedCertificate(qword objectHandle, qword certificateHandle)`

### Description

Add function to put CA certificate into the trust store that is used for chain verification.
