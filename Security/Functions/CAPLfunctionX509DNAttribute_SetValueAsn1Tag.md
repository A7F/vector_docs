[Open topic with navigation](../../../../../CANoeDEFamily.htm#Topics/CAPLFunctions/Security/Functions/CAPLfunctionX509DNAttribute_SetValueAsn1Tag.md)

## X509DNAttribute_SetValueAsn1Tag

[CAPL Functions](../../CAPLfunctions.md) » [Security](../CAPLFunctionsSecurityOverview.md) » X509DNAttribute_SetValueAsn1Tag

**Valid for:** CANoe DE • CANoe4SW DE

### Method Syntax

`dword X509DNAttribute_SetValueAsn1Tag(qword objectHandle, dword newValue)`

### Description

Setter function for the ASN.1 Tag field of the X.509 DN Attribute handle.
