...
dword X509Extension_SetOid(qword objectHandle, qword newValue)

## Description

Setter function for the Object Identifier (OID) field of the X.509 Extension handle. Can also be used to remove the field by calling the function with value 0 (NULL).
