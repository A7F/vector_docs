[Open topic with navigation](../../../../../CANoeDEFamily.htm#Topics/CAPLFunctions/Security/Functions/CAPLfunctionPkcs10SigningRequest_GetPublicKey.md)

[CAPL Functions](../../CAPLfunctions.md) » [Security](../CAPLFunctionsSecurityOverview.md) » Pkcs10SigningRequest_GetPublicKey

# Pkcs10SigningRequest_GetPublicKey

[Valid for](../../../Shared/FeatureAvailability.md):  CANoe DE • CANoe4SW DE

## Method Syntax

`dword Pkcs10SigningRequest_GetPublicKey(qword objectHandle, byte[] outBuffer, dword outBufferLength)`
