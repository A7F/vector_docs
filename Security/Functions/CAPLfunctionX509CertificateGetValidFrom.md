[Open topic with navigation](../../../../../CANoeDEFamily.htm#Topics/CAPLFunctions/Security/Functions/CAPLfunctionX509CertificateGetValidFrom.md)

## X509Certificate_GetValidFrom

[CAPL Functions](../../CAPLfunctions.md) » [Security](../CAPLFunctionsSecurityOverview.md) » X509Certificate_GetValidFrom

**Valid for**: [CANoe DE](../../../Shared/FeatureAvailability.md) • CANoe4SW DE

### Method Syntax

`dword X509Certificate_GetValidFrom(qword objectHandle, char[] outBuffer, dword outBufferLength)`

### Description

Getter function for the Valid From (NotBefore) field of the X.509 Certificate handle.
