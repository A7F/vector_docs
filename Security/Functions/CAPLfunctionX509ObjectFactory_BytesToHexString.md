[Open topic with navigation](../../../../../CANoeDEFamily.htm#Topics/CAPLFunctions/Security/Functions/CAPLfunctionX509ObjectFactory_BytesToHexString.md)

**CAPL Functions** » [Security](../CAPLFunctionsSecurityOverview.md) » X509ObjectFactory_BytesToHexString

# X509ObjectFactory_BytesToHexString

[Valid for](../../../Shared/FeatureAvailability.md): CANoe DE • CANoe4SW DE

## Method Syntax

`dword X509ObjectFactory_BytesToHexString(qword objectHandle, byte[] binaryData, dword binaryDataLength, char[] outBuffer, dword outBufferLength)`

## Description

Helper function for conversion of arbitrary byte buffer into hexadecimal representation in format 112233AABBCC
