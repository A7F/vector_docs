[Open topic with navigation](../../../../../CANoeDEFamily.htm#Topics/CAPLFunctions/Security/Functions/CAPLfunctionX509Extension_GetValue.md)

# X509Extension_GetValue

[CAPL Functions](../../CAPLfunctions.md) » [Security](../CAPLFunctionsSecurityOverview.md) » X509Extension_GetValue

**Valid for**: CANoe DE • CANoe4SW DE

## Method Syntax

`dword X509Extension_GetValue(qword objectHandle, byte[] outBuffer, dword outBufferLength)`

## Description

Getter function for the value field of the X.509 Extension handle.

## Parameters

- **objectHandle**: (in) Handle with type 'X509Extension'. The function will be called in context of this handle.
