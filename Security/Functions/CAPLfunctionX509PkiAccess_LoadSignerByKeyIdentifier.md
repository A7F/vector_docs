[Open topic with navigation](../../../../../CANoeDEFamily.htm#Topics/CAPLFunctions/Security/Functions/CAPLfunctionX509PkiAccess_LoadSignerByKeyIdentifier.md)

# X509PkiAccess_LoadSignerByKeyIdentifier

[CAPL Functions](../../CAPLfunctions.md) » [Security](../CAPLFunctionsSecurityOverview.md) » X509PkiAccess_LoadSignerByKeyIdentifier
...
```plaintext
dword X509PkiAccess_LoadSignerByKeyIdentifier(qword objectHandle, byte[] keyIdentifier, dword keyIdentifierLength, char[] hashFunction, qword& outHandleSigner)
```

```plaintext
dword X509PkiAccess_LoadSignerByKeyIdentifier(qword objectHandle, byte[] keyIdentifier, dword keyIdentifierLength, char[] hashFunction, char[] signatureAlgorithm, qword& outHandleSigner)
```
