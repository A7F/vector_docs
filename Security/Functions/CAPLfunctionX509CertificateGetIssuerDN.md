[Open topic with navigation](../../../../../CANoeDEFamily.htm#Topics/CAPLFunctions/Security/Functions/CAPLfunctionX509CertificateGetIssuerDN.md)

**CAPL Functions** » [Security](../CAPLFunctionsSecurityOverview.md) » X509Certificate_GetIssuerDN

# X509Certificate_GetIssuerDN

[Valid for](../../../Shared/FeatureAvailability.md): CANoe DE • CANoe4SW DE

## Method Syntax

`dword X509Certificate_GetIssuerDN(qword objectHandle, qword& outHandleDN)`

## Description

Getter function for the Issuer field of the X.509 Certificate handle.
