[Open topic with navigation](../../../../../CANoeDEFamily.htm#Topics/CAPLFunctions/Security/Functions/CAPLfunctionX509PkiAccess_LoadCertificateByKeyIdentifier.md)

**CAPL Functions** » [Security](../CAPLFunctionsSecurityOverview.md) » X509PkiAccess_LoadCertificateByKeyIdentifier

# X509PkiAccess_LoadCertificateByKeyIdentifier

[Valid for](../../../Shared/FeatureAvailability.md): CANoe DE • CANoe4SW DE

## Method Syntax

`dword X509PkiAccess_LoadCertificateByKeyIdentifier(qword objectHandle, byte[] keyIdentifier, dword keyIdentifierLength, qword& outHandleCertificate)`

## Description

Creation function for signer Certificate handle by Subject Key Identifier of the signer certificate from an associated Security Profile. The Security Profile has to be assigned to the network of the CAPL node.
