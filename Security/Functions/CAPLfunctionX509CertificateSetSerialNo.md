[Open topic with navigation](../../../../../CANoeDEFamily.htm#Topics/CAPLFunctions/Security/Functions/CAPLfunctionX509CertificateSetSerialNo.md)

**CAPL Functions** » [Security](../CAPLFunctionsSecurityOverview.md) » X509Certificate_SetSerialNo

# X509Certificate_SetSerialNo

[Valid for](../../../Shared/FeatureAvailability.md):  CANoe DE • CANoe4SW DE

## Method Syntax

`dword X509Certificate_SetSerialNo(qword objectHandle, byte[] newValue, dword newValueLength)`

## Description

Setter function for the Serial Number field of the X.509 Certificate handle.
