[Open topic with navigation](../../../../../CANoeDEFamily.htm#Topics/CAPLFunctions/Security/Functions/CAPLfunctionPkcs10SigningRequest_GetExtensionRequest.md)

[CAPL Functions](../../CAPLfunctions.md) » [Security](../CAPLFunctionsSecurityOverview.md) » Pkcs10SigningRequest_GetExtensionRequest

# Pkcs10SigningRequest_GetExtensionRequest

[Valid for](../../../Shared/FeatureAvailability.md):  CANoe DE • CANoe4SW DE

## Method Syntax

`dword Pkcs10SigningRequest_GetExtensionRequest(qword objectHandle, qword& outHandleExtensions)`

## Description

Getter function for the Extension Request field of the PKCS#10 CSR handle.

## Parameters

- **objectHandle**  
  (in) Handle with type 'Pkcs10SigningRequest'. The function will be called in context of this handle.
