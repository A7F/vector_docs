[Open topic with navigation](../../../../../CANoeDEFamily.htm#Topics/CAPLFunctions/Security/Functions/CAPLfunctionX509Oid_SetOidFromString.md)

**CAPL Functions** » [Security](../CAPLFunctionsSecurityOverview.md) » X509Oid_SetOidFromString

# X509Oid_SetOidFromString

[Valid for](../../../Shared/FeatureAvailability.md): CANoe DE • CANoe4SW DE

## Method Syntax

`dword X509Oid_SetOidFromString(qword objectHandle, char[] newValue)`

## Description

Setter function for the content of the Object Identifier from string representation. Function will fail in case the string is not a valid Object Identifier in point notation.

## Parameters

- **objectHandle**: (in) Handle with type 'X509Oid'. The function will be called in context of this handle.
