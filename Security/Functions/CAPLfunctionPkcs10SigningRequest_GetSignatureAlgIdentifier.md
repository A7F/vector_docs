...
dword Pkcs10SigningRequest_GetSignatureAlgIdentifier(qword objectHandle, qword& outHandleAlgIdentifier)

## Description

Getter function for the Signature Algorithm Identifier field of the PKCS#10 CSR handle.
