[Open topic with navigation](../../../../../CANoeDEFamily.htm#Topics/CAPLFunctions/Security/Functions/CAPLfunctionX509AlgIdentifierSetParameters.md)

## X509AlgIdentifier_SetParameters

[CAPL Functions](../../CAPLfunctions.md) » [Security](../CAPLFunctionsSecurityOverview.md) » X509AlgIdentifier_SetParameters

[Valid for](../../../Shared/FeatureAvailability.md): CANoe DE • CANoe4SW DE

### Method Syntax

`dword X509AlgIdentifier_SetParameters(qword objectHandle, byte[] newValue, dword newValueLength)`

### Description

Setter function for the Parameters field of the Algorithm Identifier handle. Can also be used to remove the field by calling the function with value 0 (NULL).
