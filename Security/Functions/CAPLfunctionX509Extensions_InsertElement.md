[Open topic with navigation](../../../../../CANoeDEFamily.htm#Topics/CAPLFunctions/Security/Functions/CAPLfunctionX509Extensions_InsertElement.md)

**CAPL Functions** » [Security](../CAPLFunctionsSecurityOverview.md) » X509Extensions_InsertElement

# X509Extensions_InsertElement

[Valid for](../../../Shared/FeatureAvailability.md): CANoe DE • CANoe4SW DE

## Method Syntax

`dword X509Extensions_InsertElement(qword objectHandle, qword pos, qword newValue)`

## Description

Insert function for Extension element into an Extensions list. The new element will be inserted at the specified position. Will fail in case the position is not in valid range of the list. Valid indices will start at zero and end with 'size - 1'.
