[Open topic with navigation](../../../../../CANoeDEFamily.htm#Topics/CAPLFunctions/Security/Functions/CAPLfunctionX509ObjectFactory_BytesFromHexString.md)

[CAPL Functions](../../CAPLfunctions.md) » [Security](../CAPLFunctionsSecurityOverview.md) » X509ObjectFactory_BytesFromHexString

# X509ObjectFactory_BytesFromHexString

[Valid for](../../../Shared/FeatureAvailability.md):  CANoe DE • CANoe4SW DE

## Method Syntax

dword X509ObjectFactory_BytesFromHexString(qword objectHandle, char[] hexString, byte[] outBuffer, dword outBufferLength)

## Description

Helper function for conversion of hexadecimal string representation into byte buffer. Expected format is 112233AABBCC, the function will fail in case of invalid length or characters.
