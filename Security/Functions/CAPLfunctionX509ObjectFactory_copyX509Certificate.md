[Open topic with navigation](../../../../../CANoeDEFamily.htm#Topics/CAPLFunctions/Security/Functions/CAPLfunctionX509ObjectFactory_copyX509Certificate.md)

### CAPL Functions » Security » X509ObjectFactory_copyX509Certificate

# X509ObjectFactory_copyX509Certificate

[Valid for](../../../Shared/FeatureAvailability.md): CANoe DE • CANoe4SW DE

## Method Syntax

`dword X509ObjectFactory_copyX509Certificate(qword objectHandle, qword& outHandleCertificate, qword toBeCopiedHandle)`

## Description

Creation function for deep copy of handle with type X509Certificate.
