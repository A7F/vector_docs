[Open topic with navigation](../../../../../CANoeDEFamily.htm#Topics/CAPLFunctions/Security/Functions/CAPLfunctionPkcs10SigningRequest_GetSubjectDN.md)

**CAPL Functions** » [Security](../CAPLFunctionsSecurityOverview.md) » Pkcs10SigningRequest_GetSubjectDN

# Pkcs10SigningRequest_GetSubjectDN

[Valid for](../../../Shared/FeatureAvailability.md): CANoe DE • CANoe4SW DE

## Method Syntax

`dword Pkcs10SigningRequest_GetSubjectDN(qword objectHandle, qword& outHandleDN)`

## Description

Getter function for the Subject field of the PKCS#10 CSR handle.
