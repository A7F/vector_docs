[Open topic with navigation](../../../../../CANoeDEFamily.htm#Topics/CAPLFunctions/Security/Functions/CAPLfunctionX509Signer_GetSignatureAlgIdentifier.md)

**CAPL Functions** » [Security](../CAPLFunctionsSecurityOverview.md) » X509Signer_GetSignatureAlgIdentifier

# X509Signer_GetSignatureAlgIdentifier

[Valid for](../../../Shared/FeatureAvailability.md): CANoe DE • CANoe4SW DE

## Method Syntax

`dword X509Signer_GetSignatureAlgIdentifier(qword objectHandle, qword& outHandleAlgIdentifier)`

## Description

Getter function for the Signature Algorithm Identifier of the signer certificate.
