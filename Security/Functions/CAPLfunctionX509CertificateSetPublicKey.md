[Open topic with navigation](../../../../../CANoeDEFamily.htm#Topics/CAPLFunctions/Security/Functions/CAPLfunctionX509CertificateSetPublicKey.md)

## X509Certificate_SetPublicKey

[CAPL Functions](../../CAPLfunctions.md) » [Security](../CAPLFunctionsSecurityOverview.md) » X509Certificate_SetPublicKey

**Valid for:** CANoe DE • CANoe4SW DE

### Method Syntax

`dword X509Certificate_SetPublicKey(qword objectHandle, byte[] newValue, dword newValueLength)`

### Description

Setter function for the Public Key field of the X.509 Certificate handle.
