[Open topic with navigation](../../../../../CANoeDEFamily.htm#Topics/CAPLFunctions/Security/Functions/CAPLfunctionX509CertificateSetAuthorityKeyIdentifier.md)

[CAPL Functions](../../CAPLfunctions.md) » [Security](../CAPLFunctionsSecurityOverview.md) » X509Certificate_SetAuthorityKeyIdentifier

# X509Certificate_SetAuthorityKeyIdentifier

[Valid for](../../../Shared/FeatureAvailability.md):  CANoe DE • CANoe4SW DE

## Method Syntax

`dword X509Certificate_SetAuthorityKeyIdentifier(qword objectHandle, byte[] newValue, dword newValueLength)`

## Description

Setter function for the content of Extension 'AuthorityKeyIdentifier' ('AKID') with OID '2.5.29.35' of the X.509 Certificate handle. This function will add the Extensions list structure and the Extension itself if it is not existing.

## Parameters

- **objectHandle**  
  (in) Handle with type 'X509Certificate'. The function will be called in context of this handle.
...
- **-6**  
  InvalidArgumentHandle: Error, one or more argument handles are invalid or not suitable for this function.
