[Open topic with navigation](../../../../../CANoeDEFamily.htm#Topics/CAPLFunctions/Security/Functions/CAPLfunctionX509CertificateGetValidTo.md)

[CAPL Functions](../../CAPLfunctions.md) » [Security](../CAPLFunctionsSecurityOverview.md) » X509Certificate_GetValidTo

# X509Certificate_GetValidTo

[Valid for](../../../Shared/FeatureAvailability.md):  CANoe DE • CANoe4SW DE

## Method Syntax

`dword X509Certificate_GetValidTo(qword objectHandle, char[] outBuffer, dword outBufferLength)`

## Description

Getter function for the Valid To (NotAfter) field of the X.509 Certificate handle.
