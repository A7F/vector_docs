[Open topic with navigation](../../../../../CANoeDEFamily.htm#Topics/CAPLFunctions/Security/Functions/CAPLfunctionX509PkiAccess_LoadCertificateByName.md)

**CAPL Functions** » [Security](../CAPLFunctionsSecurityOverview.md) » X509PkiAccess_LoadCertificateByName

# X509PkiAccess_LoadCertificateByName

[Valid for](../../../Shared/FeatureAvailability.md): CANoe DE • CANoe4SW DE

## Method Syntax

`dword X509PkiAccess_LoadCertificateByName(qword objectHandle, char[] keyName, qword& outHandleCertificate)`

## Description

Creation function for signer Certificate handle by name from an associated Security Profile. The Security Profile has to be assigned to the network of the CAPL node.
