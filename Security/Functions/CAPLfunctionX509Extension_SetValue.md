[Open topic with navigation](../../../../../CANoeDEFamily.htm#Topics/CAPLFunctions/Security/Functions/CAPLfunctionX509Extension_SetValue.md)

## X509Extension_SetValue

[CAPL Functions](../../CAPLfunctions.md) » [Security](../CAPLFunctionsSecurityOverview.md) » X509Extension_SetValue

**Valid for**: CANoe DE • CANoe4SW DE

### Method Syntax

`dword X509Extension_SetValue(qword objectHandle, byte[] newValue, dword newValueLength)`

### Description

Setter function for the value field of the X.509 Extension handle.
