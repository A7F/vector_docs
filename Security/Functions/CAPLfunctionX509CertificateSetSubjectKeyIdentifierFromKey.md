[Open topic with navigation](../../../../../CANoeDEFamily.htm#Topics/CAPLFunctions/Security/Functions/CAPLfunctionX509CertificateSetSubjectKeyIdentifierFromKey.md)

[CAPL Functions](../../CAPLfunctions.md) » [Security](../CAPLFunctionsSecurityOverview.md) » X509Certificate_SetSubjectKeyIdentifierFromKey

# X509Certificate_SetSubjectKeyIdentifierFromKey

[Valid for](../../../Shared/FeatureAvailability.md):  CANoe DE • CANoe4SW DE

## Method Syntax

dword X509Certificate_SetSubjectKeyIdentifierFromKey(qword objectHandle, byte[] keyData, dword keyDataLength)

## Description

Setter function for the content of Extension 'SubjectKeyIdentifier' ('SKID') with OID '2.5.29.14' of the X.509 Certificate handle from the key argument by calculating SHA-1 hash of the key and setting the value. This function will add the Extensions list structure and the Extension itself if it is not existing.

## Parameters

- **objectHandle**: (in) Handle with type 'X509Certificate'. The function will be called in context of this handle.
