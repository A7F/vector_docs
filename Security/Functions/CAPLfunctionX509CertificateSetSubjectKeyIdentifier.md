[Open topic with navigation](../../../../../CANoeDEFamily.htm#Topics/CAPLFunctions/Security/Functions/CAPLfunctionX509CertificateSetSubjectKeyIdentifier.md)

[CAPL Functions](../../CAPLfunctions.md) » [Security](../CAPLFunctionsSecurityOverview.md) » X509Certificate_SetSubjectKeyIdentifier

# X509Certificate_SetSubjectKeyIdentifier

[Valid for](../../../Shared/FeatureAvailability.md):  CANoe DE • CANoe4SW DE

## Method Syntax

dword X509Certificate_SetSubjectKeyIdentifier(qword objectHandle, byte[] newValue, dword newValueLength)

## Description

Setter function for the content of Extension 'SubjectKeyIdentifier' ('SKID') with OID '2.5.29.14' of the X.509 Certificate handle. This function will add the Extensions list structure and the Extension itself if it is not existing.
