[Open topic with navigation](../../../../../CANoeDEFamily.htm#Topics/CAPLFunctions/Security/Functions/CAPLfunctionX509Signer_UpdateAndSignCertificate.md)

## X509Signer_UpdateAndSignCertificate

[CAPL Functions](../../CAPLfunctions.md) » [Security](../CAPLFunctionsSecurityOverview.md) » X509Signer_UpdateAndSignCertificate
...
```
dword X509Signer_UpdateAndSignCertificate(qword objectHandle, qword certificateHandle)
```
