[Open topic with navigation](../../../../../CANoeDEFamily.htm#Topics/CAPLFunctions/Security/Functions/CAPLfunctionX509Decoder_DecodeSigningRequest.md)

[CAPL Functions](../../CAPLfunctions.md) » [Security](../CAPLFunctionsSecurityOverview.md) » X509Decoder_DecodeSigningRequest

# X509Decoder_DecodeSigningRequest

[Valid for](../../../Shared/FeatureAvailability.md): CANoe DE • CANoe4SW DE

## Method Syntax

dword X509Decoder_DecodeSigningRequest(qword objectHandle, qword& outHandleCsr, byte[] csrData, dword csrDataLength)

## Description

Decoding function for a PKCS#10 Certificate Signing Request (CSR) from binary data in DER or PEM format. Function will fail in case of invalid encoded data or invalid ASN.1 or PKCS#10 CSR structure.
