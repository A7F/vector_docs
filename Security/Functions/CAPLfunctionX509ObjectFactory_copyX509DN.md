[Open topic with navigation](../../../../../CANoeDEFamily.htm#Topics/CAPLFunctions/Security/Functions/CAPLfunctionX509ObjectFactory_copyX509DN.md)

**CAPL Functions** » [Security](../CAPLFunctionsSecurityOverview.md) » X509ObjectFactory_copyX509DN

# X509ObjectFactory_copyX509DN

[Valid for](../../../Shared/FeatureAvailability.md): CANoe DE • CANoe4SW DE

## Method Syntax

`dword X509ObjectFactory_copyX509DN(qword objectHandle, qword& outHandleDN, qword toBeCopiedHandle)`

## Description

Creation function for deep copy of handle with type X509DN.
