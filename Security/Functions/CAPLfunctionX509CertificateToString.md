[Open topic with navigation](../../../../../CANoeDEFamily.htm#Topics/CAPLFunctions/Security/Functions/CAPLfunctionX509CertificateToString.md)

**CAPL Functions** » [Security](../CAPLFunctionsSecurityOverview.md) » X509Certificate_ToString
...
`dword X509Certificate_ToString(qword objectHandle, char[] outBuffer, dword outBufferLength)`

## Description

Function creates a human readable string representation of the certificate.
