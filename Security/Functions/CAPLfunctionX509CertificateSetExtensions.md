[Open topic with navigation](../../../../../CANoeDEFamily.htm#Topics/CAPLFunctions/Security/Functions/CAPLfunctionX509CertificateSetExtensions.md)

**CAPL Functions** » [Security](../CAPLFunctionsSecurityOverview.md) » X509Certificate_SetExtensions

# X509Certificate_SetExtensions

[Valid for](../../../Shared/FeatureAvailability.md):  CANoe DE • CANoe4SW DE

## Method Syntax

`dword X509Certificate_SetExtensions(qword objectHandle, qword newValue)`

## Description

Setter function for the Extensions field of the X.509 Certificate handle. Can also be used to remove the field by calling the function with value 0 (NULL).
