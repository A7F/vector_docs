[Open topic with navigation](../../../../../CANoeDEFamily.htm#Topics/CAPLFunctions/Security/Functions/CAPLfunctionX509ObjectFactory_copyX509AlgorithmIdentifier.md)

**CAPL Functions** » [Security](../CAPLFunctionsSecurityOverview.md) » X509ObjectFactory_copyX509AlgorithmIdentifier

# X509ObjectFactory_copyX509AlgorithmIdentifier

[Valid for](../../../Shared/FeatureAvailability.md):  CANoe DE • CANoe4SW DE

## Method Syntax

`dword X509ObjectFactory_copyX509AlgorithmIdentifier(qword objectHandle, qword& outHandleAlgIdentifier, qword toBeCopiedHandle)`

## Description

Creation function for deep copy of handle with type X509AlgIdentifier.
