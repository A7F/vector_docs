...
`dword X509DN_SetAttributes(qword objectHandle, qword newValue)`

## Description

Setter function for the Attributes list field of the X.509 Distinguished Name (DN) handle. Can also be used to remove the field by calling the function with value 0 (NULL).
