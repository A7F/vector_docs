[Open topic with navigation](../../../../../CANoeDEFamily.htm#Topics/CAPLFunctions/Security/Functions/CAPLfunctionX509Extensions_GetElement.md)

## X509Extensions_GetElement

[CAPL Functions](../../CAPLfunctions.md) » [Security](../CAPLFunctionsSecurityOverview.md) » X509Extensions_GetElement
...
```
dword X509Extensions_GetElement(qword objectHandle, qword& outHandleExtension, qword pos)
```

### Description

Getter function for an element in the Extensions list at specific position. Will fail in case the position is not in valid range of the list. Since the list is ordered, the element index is stable. Valid indices will start at zero and end with 'size - 1'.
