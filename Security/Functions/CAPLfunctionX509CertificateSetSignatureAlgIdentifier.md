[Open topic with navigation](../../../../../CANoeDEFamily.htm#Topics/CAPLFunctions/Security/Functions/CAPLfunctionX509CertificateSetSignatureAlgIdentifier.md)

[CAPL Functions](../../CAPLfunctions.md) » [Security](../CAPLFunctionsSecurityOverview.md) » X509Certificate_SetSignatureAlgIdentifier

# X509Certificate_SetSignatureAlgIdentifier

[Valid for](../../../Shared/FeatureAvailability.md):  CANoe DE • CANoe4SW DE

## Method Syntax

`dword X509Certificate_SetSignature(qword objectHandle, byte[] newValue, dword newValueLength)`

## Description

Setter function for the Signature Algorithm Identifier field of the X.509 Certificate handle. Can also be used to remove the field by calling the function with value 0 (NULL).
