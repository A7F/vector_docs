[Open topic with navigation](../../../../../CANoeDEFamily.htm#Topics/CAPLFunctions/Security/Functions/CAPLfunctionX509Extension_SetIsCritical.md)

[CAPL Functions](../../CAPLfunctions.md) » [Security](../CAPLFunctionsSecurityOverview.md) » X509Extension_SetIsCritical

# X509Extension_SetIsCritical

[Valid for](../../../Shared/FeatureAvailability.md): CANoe DE • CANoe4SW DE

## Method Syntax

`dword X509Extension_SetIsCritical(qword objectHandle, dword newValue)`

## Description

Setter function for the Critical field of the X.509 Extension handle.

## Parameters

- **objectHandle**  
  (in) Handle with type 'X509Extension'. The function will be called in context of this handle.
