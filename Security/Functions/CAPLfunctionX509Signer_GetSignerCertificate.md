[Open topic with navigation](../../../../../CANoeDEFamily.htm#Topics/CAPLFunctions/Security/Functions/CAPLfunctionX509Signer_GetSignerCertificate.md)

**CAPL Functions** » [Security](../CAPLFunctionsSecurityOverview.md) » X509Signer_GetSignerCertificate

# X509Signer_GetSignerCertificate

[Valid for](../../../Shared/FeatureAvailability.md): CANoe DE • CANoe4SW DE

## Method Syntax

`dword X509Signer_GetSignerCertificate(qword objectHandle, qword& outHandleCertificate)`

## Description

Getter function for the signer certificate.
