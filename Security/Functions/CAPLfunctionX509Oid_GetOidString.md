[Open topic with navigation](../../../../../CANoeDEFamily.htm#Topics/CAPLFunctions/Security/Functions/CAPLfunctionX509Oid_GetOidString.md)

## CAPL Functions » Security » X509Oid_GetOidString

# X509Oid_GetOidString
...
```
dword X509Oid_GetOidString(qword objectHandle, char[] outBuffer, dword outBufferLength)
```

### Description

Getter function for the string representation of the numerical content field of the X.509 OID handle in string representation. String will have point notation.
