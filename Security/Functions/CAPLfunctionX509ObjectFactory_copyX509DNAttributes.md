[Open topic with navigation](../../../../../CANoeDEFamily.htm#Topics/CAPLFunctions/Security/Functions/CAPLfunctionX509ObjectFactory_copyX509DNAttributes.md)

[CAPL Functions](../../CAPLfunctions.md) » [Security](../CAPLFunctionsSecurityOverview.md) » X509ObjectFactory_copyX509DNAttributes

# X509ObjectFactory_copyX509DNAttributes

[Valid for](../../../Shared/FeatureAvailability.md):  CANoe DE • CANoe4SW DE

## Method Syntax

`dword X509ObjectFactory_copyX509DNAttributes(qword objectHandle, qword& outHandleDNAttributes, qword toBeCopiedHandle)`

## Description

Creation function for deep copy of handle with type X509DNAttributes.

## Parameters

- **objectHandle**  
  (in) Handle with type 'X509ObjectFactory'. The function will be called in context of this handle.
