[Open topic with navigation](../../../../../CANoeDEFamily.htm#Topics/CAPLFunctions/MOST/EventProcedures/CAPLfunctionOnMOSTGroupAdr.md)

[CAPL Functions](../../CAPLfunctions.md) » [MOST](../CAPLfunctionsMOSTOverview.md) » OnMostGroupAdr
...
The group address of the network interface to the MOST bus has changed. The value of the new group address is in the **groupadr** parameter.
...
[mostSetGroupAdr](../Functions/CAPLfunctionMOSTSetNodeAdr.md) • [mostGetGroupAdr](../Functions/CAPLfunctionMOSTGetNodeAdr.md)
