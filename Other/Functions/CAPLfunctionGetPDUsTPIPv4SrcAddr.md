[Open topic with navigation](../../../../../CANoeDEFamily.htm#Topics/CAPLFunctions/Other/Functions/CAPLfunctionGetPDUsTPIPv4SrcAddr.md)

**CAPL Functions** » [General](../CAPLGeneralStartPage.md) » [Function Overview](../CAPLfunctionsGeneralOverview.md) » GetPDUsTPIPv4SrcAddr

# GetPDUsTPIPv4SrcAddr
...
```
long GetPDUsTPIPv4SrcAddr(this, dword &IPv4SourceAddress);
```

## Description

This function can only be used within a [on PDU](../EventProcedures/CAPLfunctionOnPDU.md) handler. If the PDU was received via IPv4, with this function the IPv4 source address can be requested.
