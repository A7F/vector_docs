[Open topic with navigation](../../../../../CANoeDEFamily.htm#Topics/CAPLFunctions/Other/Functions/CAPLfunctionlookupSysvarString.md)

**CAPL Functions** » **General** » **Function Overview** » **lookupSysvarString**
...
- `sysvarString * lookupSysvarString(char sysvarPath[]); // form 1`
- `sysvarString * lookupSysvarString(char namespace[], char sysvarName[]); // form 2`
