[Open topic with navigation](../../../../../CANoeDEFamily.htm#Topics/CAPLFunctions/Other/Functions/CAPLfunctionGetPDUsTPTCPDstPort.md)

**CAPL Functions** » **General** » **Function Overview** » **GetPDUsTPTCPDstPort**
...
This function can only be used within a [on PDU](../EventProcedures/CAPLfunctionOnPDU.md) handler. If the PDU was received via TCP, with this function the TCP destination port can be requested.
