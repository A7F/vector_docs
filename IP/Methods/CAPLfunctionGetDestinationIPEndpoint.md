[Open topic with navigation](../../../../../CANoeDEFamily.htm#Topics/CAPLFunctions/IP/Methods/CAPLfunctionGetDestinationIPEndpoint.md)

[CAPL Functions](../../CAPLfunctions.md) » [Ethernet](../CAPLEthernetStartPage.md) » [Function Overview](../CAPLfunctionsIPOverview.md) » ethernetPacket::GetDestinationIPEndpoint

# ethernetPacket::GetDestinationIPEndpoint
...
Assigns the destination IP address and UDP/TCP port number to an ip_Endpoint variable.
