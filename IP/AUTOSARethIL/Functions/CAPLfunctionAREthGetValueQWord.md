[Open topic with navigation](../../../../../../CANoeDEFamily.htm#Topics/CAPLFunctions/IP/AUTOSARethIL/Functions/CAPLfunctionAREthGetValueQWord.md)

**CAPL Functions** » **Ethernet** » **AUTOSAR Eth IL** » **AREthGetValueQWord**
...
```plaintext
qword AREthGetValueQWord( dword objectHandle, char valuePath[] );
```
