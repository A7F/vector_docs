[Open topic with navigation](../../../../../../CANoeDEFamily.htm#Topics/CAPLFunctions/IP/AUTOSARethIL/Functions/CAPLfunctionAREthSetValueLong.md)

**CAPL Functions** » **Ethernet** » **AUTOSAR Eth IL** » **AREthSetValueLong**
...
```plaintext
long AREthSetValueLong( dword objectHandle, char valuePath[], long value );
```
...
- **objectHandle**: Handle to a AUTOSAR Eth IL object, which must be completely described in the AUTOSAR database.
  - Supported objects:
    - Messages
    - Fields
