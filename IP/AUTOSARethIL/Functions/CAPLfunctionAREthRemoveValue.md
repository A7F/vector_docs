[Open topic with navigation](../../../../../../CANoeDEFamily.htm#Topics/CAPLFunctions/IP/AUTOSARethIL/Functions/CAPLfunctionAREthRemoveValue.md)

**CAPL Functions** » **Ethernet** » **AUTOSAR Eth IL** » AREthRemoveValue
