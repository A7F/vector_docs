[Open topic with navigation](../../../../../../CANoeDEFamily.htm#Topics/CAPLFunctions/IP/AUTOSARethIL/Functions/CAPLfunctionAREthRemoveEventConsumer.md)

**CAPL Functions** » **Ethernet** » **AUTOSAR Eth IL** » AREthRemoveEventConsumer
