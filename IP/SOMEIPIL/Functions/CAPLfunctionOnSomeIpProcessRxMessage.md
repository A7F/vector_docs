[Open topic with navigation](../../../../../../CANoeDEFamily.htm#Topics/CAPLFunctions/IP/SOMEIPIL/Functions/CAPLfunctionOnSomeIpProcessRxMessage.md)

**CAPL Functions** » **Ethernet** » **SOME/IP IL** » **OnSomeIpProcessRxMessage**
