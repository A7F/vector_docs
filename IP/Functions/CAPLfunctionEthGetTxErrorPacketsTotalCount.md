[Open topic with navigation](../../../../../CANoeDEFamily.htm#Topics/CAPLFunctions/IP/Functions/CAPLfunctionEthGetTxErrorPacketsTotalCount.md)

[CAPL Functions](../../CAPLfunctions.md) » [Ethernet](../CAPLEthernetStartPage.md) » [Function Overview](../CAPLfunctionsIPOverview.md) » ethGetTxErrorPacketsTotalCount
...
```
qword ethGetTxErrorPacketsTotalCount(ethernetPort port);
```

## Description

Returns the number of transmitted error packets of the specified port.
...
Number of transmitted error packets, **0** if no valid value currently exists.
