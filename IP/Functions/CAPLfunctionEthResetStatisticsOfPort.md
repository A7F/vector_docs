[Open topic with navigation](../../../../../CANoeDEFamily.htm#Topics/CAPLFunctions/IP/Functions/CAPLfunctionEthResetStatisticsOfPort.md)

**CAPL Functions** » [Ethernet](../CAPLEthernetStartPage.md) » [Function Overview](../CAPLfunctionsIPOverview.md) » ethResetStatisticsOfPort
...
```plaintext
void ethResetStatisticsOfPort( ethernetPort port);
```

## Description

Resets the RT statistic values of the port. It will not influence the Statistic Window or the system variables.
