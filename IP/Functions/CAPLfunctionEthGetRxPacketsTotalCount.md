[Open topic with navigation](../../../../../CANoeDEFamily.htm#Topics/CAPLFunctions/IP/Functions/CAPLfunctionEthGetRxPacketsTotalCount.md)

[CAPL Functions](../../CAPLfunctions.md) » [Ethernet](../CAPLEthernetStartPage.md) » [Function Overview](../CAPLfunctionsIPOverview.md) » ethGetRxPacketsTotalCount
...
```
qword ethGetRxPacketsTotalCount(ethernetPort port);
```

## Description

Returns the number of received packets of the specified port.
...
Number of received packets, **0** if no valid value currently exists.
