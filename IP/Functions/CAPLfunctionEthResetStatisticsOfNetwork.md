[Open topic with navigation](../../../../../CANoeDEFamily.htm#Topics/CAPLFunctions/IP/Functions/CAPLfunctionEthResetStatisticsOfNetwork.md)

**CAPL Functions** » **Ethernet** » **Function Overview** » **ethResetStatisticsOfNetwork**
...
```plaintext
void ethResetStatisticsOfNetwork( ethernetPort portOnNetwork);
```

## Description

Resets the RT statistic values of all ports of the Ethernet network on which the passed port exists. It will not influence the Statistic Window or the system variables.

## Parameters

- **portOnNetwork**: A port of the addressed network.
