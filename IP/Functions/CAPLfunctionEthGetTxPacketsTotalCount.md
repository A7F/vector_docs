[Open topic with navigation](../../../../../CANoeDEFamily.htm#Topics/CAPLFunctions/IP/Functions/CAPLfunctionEthGetTxPacketsTotalCount.md)

[CAPL Functions](../../CAPLfunctions.md) » [Ethernet](../CAPLEthernetStartPage.md) » [Function Overview](../CAPLfunctionsIPOverview.md) » ethGetTxPacketsTotalCount
...
```
qword ethGetTxPacketsTotalCount(ethernetPort port);
```

## Description

Returns the number of transmitted packets of the specified port.
...
Number of transmitted packets, **0** if no valid value currently exists.
