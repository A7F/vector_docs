[Open topic with navigation](../../../../../CANoeDEFamily.htm#Topics/CAPLFunctions/IP/Functions/CAPLfunctionEthGetTxBytesTotalCount.md)

[CAPL Functions](../../CAPLfunctions.md) » [Ethernet](../CAPLEthernetStartPage.md) » [Function Overview](../CAPLfunctionsIPOverview.md) » ethGetTxBytesTotalCount
...
`qword ethGetTxBytesTotalCount(ethernetPort port);`

## Description

Returns the number of transmitted bytes of the specified port.
...
Number of transmitted bytes, **0** if no valid value currently exists.
