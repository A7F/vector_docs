[Open topic with navigation](../../../../../CANoeDEFamily.htm#Topics/CAPLFunctions/IP/Functions/CAPLfunctionEthGetTxBitRate.md)

[CAPL Functions](../../CAPLfunctions.md) » [Ethernet](../CAPLEthernetStartPage.md) » [Function Overview](../CAPLfunctionsIPOverview.md) » ethGetTxBitRate
...
```
qword ethGetTxBitRate(ethernetPort port, ValueSelector valueSelector);
```

## Description

Returns the TX bitrate of the specified port. The parameter **valueSelector** controls whether the minimum value, the maximum value, the average value or the current value has to be returned.
...
TX bitrate in [Bit/sec], **0** if no valid value currently exists.
