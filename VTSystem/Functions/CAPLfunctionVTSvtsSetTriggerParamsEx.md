[Open topic with navigation](../../../../../CANoeDEFamily.htm#Topics/CAPLFunctions/VTSystem/Functions/CAPLfunctionVTSvtsSetTriggerParamsEx.md)

[CAPL Functions](../../CAPLfunctions.md) » [VT System](../CAPLfunctionsVTSystemOverview.md) » vtsSetTriggerParamsEx
...
The function configures additional parameters for VT System triggers. Basic parameters are configured using [vtsSetTriggerParams](CAPLfunctionVTSvtsSetTriggerParams.md).
...
- **Trigger**: Specifies which trigger is configured. VT1004 module: Values see [eVTSTrigger](../CAPLfunctionsVTSystemEnumeration.md#eVTSTrigger).
