[Open topic with navigation](../../../../../CANoeDEFamily.htm#Topics/CAPLFunctions/VTSystem/Functions/CAPLfunctionVTSvtsSetTriggerParams.md)
...
The function configures basic parameters for triggers. Further parameters can be set with the function [vtsSetTriggerParamsEx](CAPLfunctionVTSvtsSetTriggerParamsEx.md).
...
- **Target**: Specifies which trigger is configured: Values see [eVTSTrigger](../CAPLfunctionsVTSystemEnumeration.md#eVTSTrigger)
...
- **EdgeType**: Values see [eVTSTriggerEdgeType](../CAPLfunctionsVTSystemEnumeration.md#eVTSTriggerEdgeType). If a triggered is configured to **level** type using [vtsSetTriggerParamsEx](CAPLfunctionVTSvtsSetTriggerParamsEx.md) this parameter sets which level is detected.
...
[SetTriggerParams](CAPLfunctionVTSSetTriggerParams.md)
