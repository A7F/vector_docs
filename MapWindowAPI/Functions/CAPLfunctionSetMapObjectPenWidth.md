[Open topic with navigation](../../../../../CANoeDEFamily.htm#Topics/CAPLFunctions/MapWindowAPI/Functions/CAPLfunctionSetMapObjectPenWidth.md)

**CAPL Functions** » **Map Window API** » **SetMapObjectPenWidth**
