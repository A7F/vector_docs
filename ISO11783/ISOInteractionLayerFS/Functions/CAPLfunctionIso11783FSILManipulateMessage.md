[Open topic with navigation](../../../../../../CANoeDEFamily.htm#Topics/CAPLFunctions/ISO11783/ISOInteractionLayerFS/Functions/CAPLfunctionIso11783FSILManipulateMessage.md)

[CAPL Functions](../../../CAPLfunctions.md) » [ISO11783](../../CAPLfunctionsISO11783Overview.md) » [File Server Interaction Layer (FS IL)](../CAPLfunctionsISOILFSOverview.md) » FSIL_ManipulateMessage
...
long FSIL_ManipulateMessage( dbNode node, dword pgn, dword destinationAddress, qword filterMask, qword filterValue, qword dataMask, qword dataValue ); // form 2
```
...
To revert this command you can use [FSIL_ResetManipulatedMessage](CAPLfunctionIso11783FSILResetManipulatedMessage.md) or [FSIL_ResetAllManipulatedMessages](CAPLfunctionIso11783FSILResetAllManipulatedMessages.md).
