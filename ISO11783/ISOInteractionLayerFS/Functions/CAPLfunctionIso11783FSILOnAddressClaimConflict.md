[Open topic with navigation](../../../../../../CANoeDEFamily.htm#Topics/CAPLFunctions/ISO11783/ISOInteractionLayerFS/Functions/CAPLfunctionIso11783FSILOnAddressClaimConflict.md)

**CAPL Functions** » **ISO11783** » **File Server Interaction Layer (FS IL)** » **FSIL_OnAddressClaimConflict**

# FSIL_OnAddressClaimConflict (Callback)
...
```
dword FSIL_OnAddressClaimConflict(dword addressArbitrationResult, dword nextAddress, dword& suppressAddressClaimed);
```
...
on preStart
{
  FSIL_SetNodeProperty("AddressClaimSupport", ExtendedAddressClaimSupport);
}
