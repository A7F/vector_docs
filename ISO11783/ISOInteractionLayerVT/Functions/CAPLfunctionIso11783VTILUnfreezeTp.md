[Open topic with navigation](../../../../../../CANoeDEFamily.htm#Topics/CAPLFunctions/ISO11783/ISOInteractionLayerVT/Functions/CAPLfunctionIso11783VTILUnfreezeTp.md)

**CAPL Functions** » **ISO11783** » **Virtual Terminal Interaction Layer (VT IL)** » **VTIL_UnfreezeTp**
...
- `long VTIL_UnfreezeTp(dword protocol, dword sa, dword da); //Form 1`
- `long VTIL_UnfreezeTp(dbNode node, dword protocol, dword sa, dword da); //Form 2`
...
Only a connection that has been frozen by [VTIL_ILFreezeTp](CAPLfunctionIso11783VTILFreezeTp.md) can be resumed.
