[Open topic with navigation](../../../../../../CANoeDEFamily.htm#Topics/CAPLFunctions/ISO11783/ISOInteractionLayerVT/Functions/CAPLfunctionIso11783VTILKillTp.md)

**CAPL Functions** » **ISO11783** » **Virtual Terminal Interaction Layer (VT IL)** » **VTIL_KillTp**
...
```plaintext
long VTIL_KillTp(dword protocol, dword sa, dword da); //Form 1
long VTIL_KillTp(dbNode node, dword protocol, dword sa, dword da); //Form 2
```
