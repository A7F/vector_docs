[Open topic with navigation](../../../../../../CANoeDEFamily.htm#Topics/CAPLFunctions/ISO11783/ISOInteractionLayerTC/Functions/CAPLfunctionIso11783TCILManipulateMessage.md)

[CAPL Functions](../../../CAPLfunctions.md) » [ISO11783](../../CAPLfunctionsISO11783Overview.md) » [Task Controller Interaction Layer (TC IL)](../CAPLfunctionsISOILTCOverview.md) » TCIL_ManipulateMessage

# TCIL_ManipulateMessage
...
```plaintext
long TCIL_ManipulateMessage( dword pgn, dword destinationAddress, qword filterMask, qword filterValue, qword dataMask, qword dataValue ); // form 1
long TCIL_ManipulateMessage( dbNode node, dword pgn, dword destinationAddress, qword filterMask, qword filterValue, qword dataMask, qword dataValue ); // form 2
```
...
To revert this command you can use [TCIL_ResetManipulatedMessage](CAPLfunctionIso11783TCILResetManipulatedMessage.md) or [TCIL_ResetAllManipulatedMessages](CAPLfunctionIso11783TCILResetAllManipulatedMessages.md).
