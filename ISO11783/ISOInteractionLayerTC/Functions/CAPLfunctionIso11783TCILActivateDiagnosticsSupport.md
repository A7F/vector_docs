[Open topic with navigation](../../../../../../CANoeDEFamily.htm#Topics/CAPLFunctions/ISO11783/ISOInteractionLayerTC/Functions/CAPLfunctionIso11783TCILActivateDiagnosticsSupport.md)

**CAPL Functions** » [ISO11783](../../CAPLfunctionsISO11783Overview.md) » [Task Controller Interaction Layer (TC IL)](../CAPLfunctionsISOILTCOverview.md) » TCIL_ActivateDiagnosticsSupport

# TCIL_ActivateDiagnosticsSupport
...
```plaintext
long TCIL_ActivateDiagnosticsSupport(byte enable); // form 1
long TCIL_ActivateDiagnosticsSupport(dbNode node, byte enable); // form 2
```
