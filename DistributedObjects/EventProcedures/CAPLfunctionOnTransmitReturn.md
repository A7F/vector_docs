[Open topic with navigation](../../../../../CANoeDEFamily.htm#Topics/CAPLFunctions/DistributedObjects/EventProcedures/CAPLfunctionOnTransmitReturn.md)

**CAPL Functions** » **Distributed Objects** » **on transmit_return**
...
`on transmit_return <Member>;`

## Description

This handler is called whenever a provided method member transmits a return via the [CAPL binding](../../../CANoeCANalyzer/CommunicationConcept/CCDOCAPLBinding.md).
