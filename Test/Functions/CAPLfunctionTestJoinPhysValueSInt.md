[Open topic with navigation](../../../../../CANoeDEFamily.htm#Topics/CAPLFunctions/Test/Functions/CAPLfunctionTestJoinPhysValueSInt.md)

[CAPL Functions](../../CAPLfunctions.md) » [Test Feature Set](../CAPLfunctionsTFSOverview.md) » TestJoinPhysValueSInt

# TestJoinPhysValueSInt

[Valid for](../../../Shared/FeatureAvailability.md): CANoe DE • CANoe:lite DE • CANoe4SW DE • CANoe4SW:lite DE

## Function Syntax

- `long TestJoinPhysValueSInt(valueHandle * value, int64 awaitedValue); // form 1`
- `long TestJoinPhysValueSInt(valueHandle * value, int64 awaitedValue, dword waitForValueUpdate); // form 2`
...
long ret;
dword index = 0;
ret = testJoinPhysValueSInt(ErrorSignal[LeftMirror], -1, 1);
