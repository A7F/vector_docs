[Open topic with navigation](../../../../../CANoeDEFamily.htm#Topics/CAPLFunctions/Test/Functions/CAPLfunctionTestJoinSignalInRange.md)

[CAPL Functions](../../CAPLfunctions.md) » [Test Feature Set](../CAPLfunctionsTFSOverview.md) » TestJoinSignalInRange
...
- **aSignal**: Signal that should be awaited with a value inside or equal the limits.
- **aEnvVar**: Environment variable that should be awaited with a value inside or equal the limits.
- **aSysVar**: System variable that should be awaited with a value inside or equal the limits. May also be a specific element of a variable of type struct or generic array.
...
```c
// waits until the value of signal or system variable ‚Velocity’ is in the given range
long result;
dword index = 0;
...
[TestWaitForSignalInRange](CAPLfunctionTestWaitForSignalInRange.md) • [TestWaitForAnyJoinedEvent](CAPLfunctionTestWaitForAnyJoinedEvent.md) • [TestWaitForAllJoinedEvents](CAPLfunctionTestWaitForAllJoinedEvents.md)
