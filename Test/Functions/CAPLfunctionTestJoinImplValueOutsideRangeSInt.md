[Open topic with navigation](../../../../../CANoeDEFamily.htm#Topics/CAPLFunctions/Test/Functions/CAPLfunctionTestJoinImplValueOutsideRangeSInt.md)

[CAPL Functions](../../CAPLfunctions.md) » [Test Feature Set](../CAPLfunctionsTFSOverview.md) » TestJoinImplValueOutsideRangeSInt

# TestJoinImplValueOutsideRangeSInt
...
```plaintext
long TestJoinImplValueOutsideRangeSInt(valueHandle * value, int64 aLowLimit, int64 aHighLimit); // form 1
long TestJoinImplValueOutsideRangeSInt(valueHandle * value, int64 aLowLimit, int64 aHighLimit, word waitForSignalUpdate); // form 2
```
...
long ret;
dword index = 0;
ret = testJoinImplValueOutsideRangeSInt(MirrorStatus[CANoe].Temperature, 20, 30);
// ... other join events
index = TestWaitForAnyJoinedEvent(2000);
```

[TestJoinImplValueOutsideRangeFloat](CAPLfunctionTestJoinImplValueOutsideRangeFloat.md) • [TestJoinImplValueOutsideRangeUInt](CAPLfunctionTestJoinImplValueOutsideRangeUInt.md)
