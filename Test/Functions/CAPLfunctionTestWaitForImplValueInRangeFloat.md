[Open topic with navigation](../../../../../CANoeDEFamily.htm#Topics/CAPLFunctions/Test/Functions/CAPLfunctionTestWaitForImplValueInRangeFloat.md)

## CAPL Functions » Test Feature Set » TestWaitForImplValueInRangeFloat

# TestWaitForImplValueInRangeFloat
...
```plaintext
long TestWaitForImplValueInRangeFloat(valueHandle * value, float aLowLimit, float aHighLimit, dword aTimeout);
```
...
[TestWaitForImplValueInRangeSInt](CAPLfunctionTestWaitForImplValueInRangeSInt.md) • [TestWaitForImplValueInRangeUInt](CAPLfunctionTestWaitForImplValueInRangeUInt.md)
