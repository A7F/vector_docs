[Open topic with navigation](../../../../../CANoeDEFamily.htm#Topics/CAPLFunctions/Test/Functions/CAPLfunctionTestJoinPhysValueInRangeSInt.md)

[CAPL Functions](../../CAPLfunctions.md) » [Test Feature Set](../CAPLfunctionsTFSOverview.md) » TestJoinPhysValueInRangeSInt

# TestJoinPhysValueInRangeSInt
...
```plaintext
long TestJoinPhysValueInRangeSInt(valueHandle * value, int64 aLowLimit, int64 aHighLimit); // form 1
long TestJoinPhysValueInRangeSInt(valueHandle * value, int64 aLowLimit, int64 aHighLimit, word waitForSignalUpdate); // form 2
```
...
long ret;
dword index = 0;
ret = testJoinPhysValueInRangeSInt(MirrorStatus[CANoe].Temperature, 20, 30);
...
[TestJoinPhysValueInRangeFloat](CAPLfunctionTestJoinPhysValueInRangeFloat.md) • [TestJoinPhysValueInRangeUInt](CAPLfunctionTestJoinPhysValueInRangeUInt.md)
