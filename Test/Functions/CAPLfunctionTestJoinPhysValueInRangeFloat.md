[Open topic with navigation](../../../../../CANoeDEFamily.htm#Topics/CAPLFunctions/Test/Functions/CAPLfunctionTestJoinPhysValueInRangeFloat.md)

[CAPL Functions](../../CAPLfunctions.md) » [Test Feature Set](../CAPLfunctionsTFSOverview.md) » TestJoinPhysValueInRangeFloat

# TestJoinPhysValueInRangeFloat
...
```plaintext
long TestJoinPhysValueInRangeFloat(valueHandle * value, float aLowLimit, float aHighLimit); // form 1
long TestJoinPhysValueInRangeFloat(valueHandle * value, float aLowLimit, float aHighLimit, word waitForSignalUpdate); // form 2
```
...
long ret;
dword index = 0;
ret = testJoinPhysValueInRangeFloat(MirrorStatus[CANoe].Temperature, 20.0, 30.0);
...
[TestJoinPhysValueInRangeSInt](CAPLfunctionTestJoinPhysValueInRangeSInt.md) • [TestJoinPhysValueInRangeUInt](CAPLfunctionTestJoinPhysValueInRangeUInt.md)
