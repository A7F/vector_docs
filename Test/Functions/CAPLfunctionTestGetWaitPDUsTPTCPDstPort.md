[Open topic with navigation](../../../../../CANoeDEFamily.htm#Topics/CAPLFunctions/Test/Functions/CAPLfunctionTestGetWaitPDUsTPTCPDstPort.md)

**CAPL Functions** » [Test Feature Set](../CAPLfunctionsTFSOverview.md) » TestGetWaitPDUsTPTCPDstPort

# TestGetWaitPDUsTPTCPDstPort

[Valid for](../../../Shared/FeatureAvailability.md): CANoe DE • CANoe4SW DE

## Function Syntax

- `long TestGetWaitPDUsTPTCPDstPort(dword &tcpDestinationPort); //form 1`
- `long TestGetWaitPDUsTPTCPDstPort(dword explicitJoinIndex, dword &tcpDestinationPort); //form 2`

## Description

If a PDU was received via TCP that triggered the last wait function, with form 1 the TCP destination port can be requested.
