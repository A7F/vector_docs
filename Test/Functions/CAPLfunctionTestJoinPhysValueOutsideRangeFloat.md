[Open topic with navigation](../../../../../CANoeDEFamily.htm#Topics/CAPLFunctions/Test/Functions/CAPLfunctionTestJoinPhysValueOutsideRangeFloat.md)

[CAPL Functions](../../CAPLfunctions.md) » [Test Feature Set](../CAPLfunctionsTFSOverview.md) » TestJoinPhysValueOutsideRangeFloat

# TestJoinPhysValueOutsideRangeFloat
...
```plaintext
long TestJoinPhysValueOutsideRangeFloat(valueHandle * value, float aLowLimit, float aHighLimit); // form 1
long TestJoinPhysValueOutsideRangeFloat(valueHandle * value, float aLowLimit, float aHighLimit, word waitForSignalUpdate); // form 2
```
...
long ret;
dword index = 0;
ret = testJoinPhysValueOutsideRangeFloat(MirrorStatus[CANoe].Temperature, 20.0, 30.0);
...
[TestJoinPhysValueOutsideRangeSInt](CAPLfunctionTestJoinPhysValueOutsideRangeSInt.md) • [TestJoinPhysValueOutsideRangeUInt](CAPLfunctionTestJoinPhysValueOutsideRangeUInt.md)
