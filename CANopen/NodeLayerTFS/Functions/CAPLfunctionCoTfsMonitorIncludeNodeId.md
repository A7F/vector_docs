[Open topic with navigation](../../../../../../CANoeDEFamily.htm#Topics/CAPLFunctions/CANopen/NodeLayerTFS/Functions/CAPLfunctionCoTfsMonitorIncludeNodeId.md)

**CAPL Functions** » **CANopen** » **Test Feature Set Node Layer** » **coTfsMonitorIncludeNodeId**

# coTfsMonitorIncludeNodeId (Level 2)
...
This function includes a single node-ID for monitoring. To include a range of node-IDs use the function [coTfsMonitorIncludeNodeIdRange](CAPLfunctionCoTfsMonitorIncludeNodeIdRange.md).
...
- **nodeID**: Node-ID to be monitored.
